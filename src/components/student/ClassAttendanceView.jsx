...
import { Activity, Trophy, FileText } from 'lucide-react';
      ...
      <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex flex-col md:flex-row justify-between items-center gap-4">
         <div>
            ...
            <p className="text-slate-500">
               {currentUser.branch} • {currentUser.batch} • {displayedStudents.length} of {classmates.length} Students
            </p>
         </div>
