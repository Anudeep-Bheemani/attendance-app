...
import { Activity, CheckCircle, AlertTriangle, Sparkles, MessageSquare, X, Loader2 } from 'lucide-react';
...
const StudentDashboard = ({ student, attendanceData, onUpdateProfile, isReadOnly }) => {
  ...
  const myAttendance = attendanceData.filter(r => r.studentId === student.id);
